...
module.exports = function Config(options) {
    ...
    if (options.storage.type === STORAGE_KNEX) {
        ...
        assert(options.storage.db.connection.database && options.storage.db.connection.user && options.storage.db.connection.password, 'Не указано подключение БД (логин, пароль)');
    }
